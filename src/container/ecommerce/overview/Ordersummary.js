...
function Ordersummary({ subtotal, checkout }) {
  ...
  return (
    <div className="bg-regularBG dark:bg-regularBGdark p-[25px] sm:p-[15px] rounded-10">
      <div>
        <Heading className="mb-6 text-xl font-semibold" as="h4">
          Order Summary
        </Heading>
        <div className="bg-white dark:bg-white10 p-[25px] shadow-[0_10px_30px_rgba(10,10,10,0.06)] rounded-10">
