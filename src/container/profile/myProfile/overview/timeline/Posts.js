        ...
        <div>
          ...
          <div className="px-[25px] pb-[20px] border-b-1 dark:border-white10 mb-[20px] flex flex-wrap items-center gap-[20px]">
            <span className="inline-flex items-center text-light-extra dark:text-white60 gap-[6px]">
              <Link
                className="inline-flex items-center text-[13px] text-light-extra dark:text-white60"
            ...
            <span className="inline-flex items-center text-light-extra dark:text-white60 gap-[6px]">
              <Link className="inline-flex items-center text-[13px] text-light-extra dark:text-white60" to="#">
            ...
            <span className="inline-flex items-center text-light-extra dark:text-white60 gap-[6px]">
              <Link
                className="inline-flex items-center text-[13px] text-light-extra dark:text-white60 gap-[6px]"
                to="#"
              >
          ...
          <div>
            <div className="flex items-center sm:flex-wrap px-[25px] pb-[20px] border-b-1 dark:border-white10 gap-[10px]">
              <div className="relative flex items-center sm:flex-wrap flex-1 sm:flex-[0_0_100%] gap-[10px]">
                ...
                />
                <div className="social-post flex items-center ltr:right-[22px] rtl:left-[22px] top-[50%] -translate-y-1/2 absolute gap-[10px]">
