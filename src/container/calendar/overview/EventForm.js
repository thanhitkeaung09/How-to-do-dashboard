...
//             <Form.Item className="w-full mb-0" name="eventTitle" initialValue={title}>
//               <Input
...
//             <Form.Item className="w-full mb-0" name="eventType" initialValue={type}>
//               <Radio.Group>
...
//               <Form.Item className="w-full mb-0" name="eventStartDate" initialValue={moment(start)}>
//                 <DatePicker
//                   className="w-full h-[50px] d-flex items-center border-normal dark:border-white10 rounded-6"
//                   format="YYYY-MM-DD"
//                 />
//               </Form.Item>
//               <Form.Item className="w-full mb-0" name="eventStartTime" initialValue={moment(start)}>
//                 <TimePicker
//                   className="w-full h-[50px] d-flex items-center border-normal dark:border-white10 rounded-6"
//                   format="h:mm:ss A"
//                 />
...
//             <div className="flex items-center w-full gap-[10px]">
//               <Form.Item className="w-full mb-0" name="eventEndDate" initialValue={moment(start)}>
//                 <DatePicker
//                   className="w-full h-[50px] d-flex items-center border-normal dark:border-white10 rounded-6"
//                   format="YYYY-MM-DD"
//                 />
//               </Form.Item>
//               <Form.Item className="w-full mb-0" name="eventEndTime" initialValue={moment(start)}>
//                 <TimePicker
//                   className="w-full h-[50px] d-flex items-center border-normal dark:border-white10 rounded-6"
//                   format="h:mm:ss A"
//                 />
...
//             <Form.Item className="w-full mb-0" name="eventDescription">
//               <Input.TextArea
...
//             <Form.Item className="w-full mb-0" name="eventLabel">
//               <Select
