          ...
          <Row gutter={25}>
            ...
            <Col xxl={18} xl={15} xs={24}>
              ...
              <Modal
                ...
                className={`hexadash-event-details-modal hexadash-event-details-modal-${selectedEvent.label}`}
                visible={isEventModalVisible}
                onCancel={handleCancel}
                footer={null}
              >
                <div>
                  <div className="hexadash-event-details-top">
                  ...
                  <div className="hexadash-event-details">
                    <ul>
                      <li>
                        <UilCalender />
                        <span className="hexadash-event-label">Date:</span>
                        <span className="hexadash-event-text">
                          <strong>
                      ...
                      <li>
                        <UilClock />
                        <span className="hexadash-event-label">Time:</span>
                        <span className="hexadash-event-text">
                          <strong>
                      ...
                      <li className="hexadash-event-description">
                        <UilSubject />
                        <span className="hexadash-event-text">
