...
//                   return (
//                     <li className="mb-[30px] px-[25px] last:mb-0" key={id} style={{ overflow: 'hidden' }}>
//                       <div
...
//                           <>
//                             <img
//                               className="max-w-[46px] ltr:mr-[15px] rtl:ml-[15px] rounded-full"
...
//                         <div>
//                           <Heading as="h5" className="text-sm font-semibold text-dark dark:text-white87 tex">
//                             {mes.email !== me && name}
//                             <span className="text-light text-xs font-normal mx-[15px]">
...
//                     style={{ width: '100%' }}
//                     value={inputValue}
//                     className="bg-section dark:bg-[#323540] h-[70px] ltr:pr-[25px] rtl:pl-[25px] ltr:pl-[70px] rtl:pr-[70px] text-body dark:text-white60 border-none outline-none rounded-[35px]"
//                   />
//                 </div>
